  ...
  const projects = [
    {
      ...
      year: "2024",
      description: "A web-based system that uses motion and gesture pattern recognition to identify suspicious activities, providing a practical approach to theft prediction.",
    ...
    },
    {
      ...
      year: "2023",
      description: "A replica of the official Dota 2 homepage, featuring immersive design, game updates, hero details, and community highlights for fans and players.",
      category: ["Design"],
      image: "/screenshots/dota2/Landing Page 1.png",
      live: false,  
      projectUrl: [
        { label: 'Figma', link: 'https://www.figma.com/design/49OJrImCKvmMbXLuPlkxNP/Dota-2?node-id=0-1&t=r47b2PIQ7Bkw0YIZ-1' }
      ],
      role: ['UI Designer'],
      frameworks: [], 
      tools: ['Figma', 'Adobe Photoshop'],
      figmaOverview: 'https://embed.figma.com/design/49OJrImCKvmMbXLuPlkxNP/Dota-2?node-id=0-1&embed-host=share',
      screenshots: [
    ...
    },
    {
      ...
      name: "AuthFetch",
      year: "2024",
      description: "A streamlined solution for authentication and data fetching built with LaraNuxt, ensuring a seamless integration of Laravel and Nuxt JS for efficient web development.",
      category: ["Code"],
      image: "/screenshots/authfetch/Landing Page.png",
      live: false,
      projectUrl: [
        { label: 'Github', link: 'https://github.com/KJLEscoto/AuthFetch-Nuxt-Laravel' }
      ],
    ...
    },
    {
      ...
      year: "2022",
      description: "An anime-inspired web page dedicated to Levi Ackerman from Attack on Titan. Dive into his iconic moments, character insights, and captivating aesthetics tailored for fans.",
      category: ["Design"],
      image: "/screenshots/levi/Landing Page.png",
      live: false,
      projectUrl: [
        { label: 'Figma', link: 'https://www.figma.com/design/wD2ulDw0oyIWsa9rzvYjmW/Levi-Inspired-Page?t=G2K4vC36jyohlT7x-1' }
      ],
      role: ['UI Designer'],
      frameworks: [], 
      tools: ['Figma'],
      figmaOverview: 'https://embed.figma.com/design/wD2ulDw0oyIWsa9rzvYjmW/Levi-Inspired-Page?embed-host=share',
      screenshots: [
    ...
    },
    {
      ...
      name: "Pixel Position",
      year: "2024",
      description: "A platform that connects employers and job seekers. Employers can post jobs and find talent, while job seekers can explore opportunities and apply effortlessly—all in one seamless experience.",
      category: ["Code"],
      image: "/screenshots/pixelposition/Landing Page.png",
      live: false,  
      projectUrl: [
        { label: 'Github', link: 'https://github.com/KJLEscoto/Pixel-Position-p2' }
      ],
      role: ['Full-Stack Developer', 'UI/UX Designer'],
    ...
    },
    {
      ...
      name: "MASSMS",
      year: "2022",
      description: "A responsive web platform that offers fully-featured SMS & mobile marketing platform that doesn't stop you from scaling.",
      category: ["Design", "Code"],
      image: "/screenshots/massms/Landing Page 1.png",
      live: true,  
      projectUrl: [
        { label: 'Figma', link: 'https://www.figma.com/design/2cqs6Qy37adrUSlLAsMBQd/MASSMS?node-id=0-1&t=vxoNmBUVnSGEs6gP-1' },
    ...
    },
    {
      ...
      name: "Beat Hub",
      year: "2022",
      description: "A go-to online hub for every drummers. It offers a wide range of percussion instruments, complete drum kits, and essential accessories to fuel your passion for drumming.",
      category: ["Design"],
    ...
    },
    {
      ...
      name: "Cine Stream",
      year: "2023",
      description: "A streaming platform for movie enthusiasts, offering the option to rent or purchase films. Enjoy a seamless cinema experience anytime, anywhere.",
      category: ["Design"],
      image: "/screenshots/cinestream/Landing Page.png",
      live: false,
      projectUrl: [
        { label: 'Figma', link: 'https://www.figma.com/design/pe9gZqCwi5R8IfZ5Cqg7pE/Cine-Stream?node-id=0-1&t=G2K4vC36jyohlT7x-1' }
      ],
      role: ['UI Designer'],
      frameworks: [], 
      tools: ['Figma', 'Adobe Photoshop'],
      figmaOverview: 'https://embed.figma.com/design/pe9gZqCwi5R8IfZ5Cqg7pE/Cine-Stream?node-id=0-1&embed-host=share',
      screenshots: [
    ...
    },
    {
      ...
      year: '2024',
      description: "A user-friendly web application designed to help tertiary students quickly and accurately compute their final grades with predefined average formula.",
      category: ["Code"],
